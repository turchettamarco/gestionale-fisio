              ...
              <div style={{ marginTop: 16 }}>
                ...
                <div style={{
                  ...
                  <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
                    <code style={{ background: "#f1f5f9", padding: "4px 8px", borderRadius: 6, fontSize: 12 }}>{`{nome}`}</code>
                    <code style={{ background: "#f1f5f9", padding: "4px 8px", borderRadius: 6, fontSize: 12 }}>{`{data_relativa}`}</code>
                    <code style={{ background: "#f1f5f9", padding: "4px 8px", borderRadius: 6, fontSize: 12 }}>{`{ora}`}</code>
                    <code style={{ background: "#f1f5f9", padding: "4px 8px", borderRadius: 6, fontSize: 12 }}>{`{luogo}`}</code>
                  </div>
