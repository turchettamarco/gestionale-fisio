    ...
    try {
      if (!isRecurring) {
        ...
        if (data && sendWhatsApp) {
          sendReminder(data.id, selectedPatient.phone || null, `${selectedPatient.last_name} ${selectedPatient.first_name}`, true);
        }
        ...
        >
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
              ...
              <div>
                <div style={{ fontSize: 18, fontWeight: 900, color: THEME.blueDark }}>Invia conferma WhatsApp?</div>
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <div style={{ marginTop: 8, fontSize: 12, color: THEME.muted, fontWeight: 900 }}>
                Destinatario: {selectedPatient?.phone || "Nessun telefono registrato"}
              </div>
            </div>
            ...
            <div style={{ display: "flex", justifyContent: "flex-end", gap: 12 }}>
              ...
              <button
                ...
                style={{
                  ...
                  background: "#25d366",
                  color: "#fff",
                  cursor: selectedPatient?.phone ? "pointer" : "not-allowed",
                  fontWeight: 900,
                  minWidth: 200,
                  fontSize: 13,
                  display: "flex",
