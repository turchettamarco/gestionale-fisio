...
export default function PainMapMobile({
  ...
  const [viewing, setViewing] = useState<SavedMap | null>(null);
        ...
        <div style={{ flex: 1, overflowY: "auto", display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: 8, position: "relative" }}>
            <div
              ...
              onClick={handleTap}
              style={{
                position: "relative", height: "min(70vh, 600px)", aspectRatio: aspectFor(view),
        ...
        return (
          <div style={{ position: "fixed", inset: 0, background: BG, zIndex: 400,
            ...
            <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: 12, overflow: "auto" }}>
              <div style={{ position: "relative", height: "min(74vh, 640px)", aspectRatio: aspectFor(viewerView),
                ...
                {vChains.length > 0 && (
                  <svg viewBox="0 0 100 100" preserveAspectRatio="none" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", pointerEvents: "none" }}>
                    <defs>
                      <marker id="radArrowBigM" markerWidth="5" markerHeight="5" refX="3.5" refY="2.5" orient="auto">
                    ...
                    {vChains.map(c => (
                      <polyline key={c.id} points={c.nodes.map(n => `${n.x * 100},${n.y * 100}`).join(" ")}
                        ...
                        strokeDasharray="2.5 1.5" markerEnd="url(#radArrowBigM)" vectorEffect="non-scaling-stroke" />
                    ))}
                  </svg>
                )}
