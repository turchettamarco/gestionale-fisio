    ...
    try {
      ...
      if (!data) {
        ...
        const seed: PracticeSettingsRow = {
          ...
          ts_enabled: false, ts_tipo_spesa_default: "SP", ts_numbering_mode: "external", ts_cf_proprietario: "", ts_regime_forfettario: true, ts_dispositivo: 1, ts_ws_user: "", ts_ws_password: "", ts_ws_pincode: "", ts_ws_ambiente: "test", ts_reminder_cadence: "monthly",
        };
      ...
      setTsWsUser(((data as PracticeSettingsRow).ts_ws_user ?? "").trim());
